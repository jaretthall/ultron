        ...
        <div className="p-4">
          ...
          <div className="space-y-2 mb-3">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium">{getDuration(suggestion.suggestedStart, suggestion.suggestedEnd)}</span>
            </div>
          ...
          {isExpanded && (
            <div className="border-t border-gray-100 pt-3 mt-3 space-y-3">
              <div>
                <h4 className="text-xs font-medium text-gray-700 mb-1">Reasoning</h4>
              ...
              {suggestion.conflictsWith && suggestion.conflictsWith.length > 0 && (
                <div>
                  <h4 className="text-xs font-medium text-red-700 mb-1">⚠️ Potential Conflicts</h4>
