...
const WorkingHoursManager: React.FC<WorkingHoursManagerProps> = ({ userPreferences, onUpdate }) => {
  ...
  const renderWorkingHoursTab = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4 text-white">General Working Hours</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="working-hours-start" className="block text-sm font-medium text-gray-200 mb-1">
              Working Hours Start
            </label>
            <input
              ...
              className="w-full border border-gray-600 rounded-lg px-3 py-2 bg-gray-800 text-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div>
            <label htmlFor="working-hours-end" className="block text-sm font-medium text-gray-200 mb-1">
              Working Hours End
            </label>
            <input
      ...
      <div>
        <h4 className="font-medium mb-2 text-white">Context Switching</h4>
                  <div>
            <label htmlFor="context-switch-buffer" className="block text-sm font-medium text-gray-200 mb-1">
  ...
  const renderBusinessHoursTab = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4 text-white">Business Hours Configuration</h3>
        <p className="text-gray-300 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div>
            <label htmlFor="business-hours-start" className="block text-sm font-medium text-gray-200 mb-1">
          ...
          <div>
            <label htmlFor="business-hours-end" className="block text-sm font-medium text-gray-200 mb-1">
              Business Hours End
            </label>
            <input
  ...
  const renderPersonalTimeTab = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4 text-white">Personal Time Configuration</h3>
        <p className="text-gray-300 mb-4">
        ...
        <div className="space-y-4">
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <div>
              <span className="font-medium text-gray-200">Early Morning Personal Time</span>
              <p className="text-sm text-gray-300">Allow personal tasks before business hours start</p>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <div>
              <span className="font-medium text-gray-200">Weekday Evening Personal Time</span>
              <p className="text-sm text-gray-300">Allow personal tasks after business hours end</p>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <div>
              <span className="font-medium text-gray-200">Weekend Personal Time</span>
              <p className="text-sm text-gray-300">Allow personal tasks on weekends and non-business days</p>
            </div>
          </label>
        </div>
      </div>
      ...
      <div>
        <h4 className="font-medium mb-3 text-white">Context Mixing Rules</h4>
        <div className="space-y-3">
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <div>
              <span className="font-medium text-gray-200">Allow Business Work in Personal Time</span>
              <p className="text-sm text-gray-300">Permit urgent business tasks during personal hours</p>
            </div>
          </label>
          ...
          <label className="flex items-center space-x-3 cursor-pointer">
            ...
            />
            <div>
              <span className="font-medium text-gray-200">Allow Personal Tasks in Business Time</span>
              <p className="text-sm text-gray-300">Permit personal tasks during business hours when appropriate</p>
            </div>
          </label>
        </div>
      </div>
  ...
  const renderFocusBlocksTab = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4 text-white">Focus Block Configuration</h3>
        <p className="text-gray-300 mb-4">
        ...
        <div className="bg-blue-900/40 border border-blue-600 rounded-lg p-4">
          <h4 className="font-medium text-blue-200 mb-2">Focus Block Preview</h4>
  ...
  const renderSchedulePreview = () => (
    <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
      <h4 className="font-semibold mb-3 text-white">Weekly Schedule Preview</h4>
      <div className="space-y-2">
        {previewSchedule?.map((daySchedule: any, index: number) => (
          <div key={index} className="flex items-center space-x-4">
            <span className="w-20 text-sm font-medium text-gray-200">{daySchedule.day}</span>
      ...
      <div className="mt-3 text-xs text-gray-300">
        <span className="inline-block w-3 h-3 bg-blue-900/40 border border-blue-600 rounded mr-1"></span>
        Business Hours
        <span className="inline-block w-3 h-3 bg-green-900/40 border border-green-600 rounded mr-1 ml-4"></span>
        Personal Time
      </div>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-900 rounded-lg shadow-xl w-full max-w-4xl h-5/6 flex flex-col border border-gray-700">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-700">
          <div>
            <h2 className="text-2xl font-bold text-white">Working Hours Manager</h2>
            <p className="text-gray-300">Configure your working hours, business time, and focus patterns</p>
          </div>
          <button
          ...
          {[
            ...
            <button
              ...
              className={`px-6 py-3 font-medium ${
                activeTab === tab.id
                  ? 'text-blue-300 border-b-2 border-blue-400 bg-blue-900/30'
