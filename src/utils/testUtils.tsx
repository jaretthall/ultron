...
export const mockProjects: Project[] = [
  {
    ...
    context: 'First test project for business development',
    goals: ['Goal 1', 'Goal 2'],
  ...
  },
  {
    ...
    context: 'Second test project for personal development',
    goals: ['Goal 3'],
...
export const mockTasks: Task[] = [
  {
    ...
    context: 'First test task for business project testing',
  ...
  },
  {
    id: 'task-2',
    title: 'Test Task 2',
    context: 'Second test task for project development',
    project_id: 'project-1',
