// Define interface for changelog entries
interface ChangelogEntry {
  readonly date: string;
  readonly changes: readonly string[];
}

export const GEMINI_MODEL_NAME = "gemini-2.5-flash-preview-04-17" as const; // Default, might be superseded by user preference
export const APP_NAME = "Ultron" as const;
...
} as const satisfies Record<string, ChangelogEntry>;
